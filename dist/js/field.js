...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('form-nova-items-field', __webpack_require__(9));
    Vue.component('detail-nova-items-field-item', __webpack_require__(20));
});
...
var render = function() {
  ...
  return _c("div", [
    _vm.field.value
      ? _c("span", [_vm._v(_vm._s(_vm.field.value.length))])
      : _c("span", [_vm._v("0")])
  ])
}
var staticRenderFns = []
  ...
  return _c("div", { staticClass: "flex border-b border-40" }, [
    ...
    _c(
      ...
      _vm._l(_vm.field.value, function(item, index) {
        return _c(
          _vm.field.detailItemComponent,
          _vm._b(
            { key: index, tag: "component", attrs: { item: item } },
            "component",
            _vm.$props,
            false
          )
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuedraggable__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuedraggable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vuedraggable__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova__ = __webpack_require__(18);
  ...
  return _c(
    ...
    [
      _c("template", { staticClass: "nova-items-field", slot: "field" }, [
        _vm.field.listFirst == false && !_vm.maxReached
          ? _c(
              "div",
              {
                staticClass:
              ...
              [
                ...
                _vm._v(" "),
                _vm.field.hideCreateButton == false
                  ? _c("a", {
                      staticClass:
                        "btn btn-default btn-primary ml-3 cursor-pointer font-sans",
                      domProps: {
                        innerHTML: _vm._s(_vm.field.createButtonValue)
                      },
        ...
        _vm.items.length
          ? _c(
              "ul",
              {
                ref: "novaitemslist",
                staticClass:
                  "nova-items-field-input-items list-reset border border-40 py-2",
                style: _vm.maxHeight
              },
              [
                _c(
                    ...
                    return _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "nova-items-field-input-wrapper-item flex py-1"
                          },
                          [
                            _vm.field.draggable &&
                            (!_vm.field.keepSaved ||
                              (_vm.field.keepSaved &&
                                !_vm.savedItems.includes(item)))
                              ? _c(
                                  "span",
                                  {
                                    staticClass:
                            ...
                            (_vm.field.keepSaved &&
                              ...
                              ? _c("span", {
                                  staticClass:
                                    "ml-4 mr-2 font-thin cursor-pointer hover:font-normal",
                                  staticStyle: { "font-size": "32px" },
                                  domProps: {
                                    innerHTML: _vm._s(
                                      _vm.field.deleteButtonValue
                                    )
                                  },
                                  on: {
                        ...
                        _vm.hasErrors(_vm.field.attribute + "." + index)
                          ? _c(
                              ...
                              {
                                staticClass:
                                  "help-text error-text -mt-2 text-danger py-2"
                              },
                              [
                                _c("p", {
                                  domProps: {
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.field.listFirst && !_vm.maxReached
          ? _c(
              "div",
              {
                staticClass:
