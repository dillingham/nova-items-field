...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-items-field', __webpack_require__(3));
    Vue.component('detail-nova-items-field', __webpack_require__(6));
    Vue.component('form-nova-items-field', __webpack_require__(12));
    Vue.component('detail-nova-items-field-item', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("div", [
    _vm.field.value
      ? _c("span", [_vm._v(_vm._s(JSON.parse(_vm.field.value).length))])
      : _c("span", [_vm._v("0")])
  ])
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex border-b border-40" }, [
    ...
    _c(
      "div",
      { staticClass: "w-3/4 pt-4" },
      _vm._l(JSON.parse(_vm.field.value), function(item, index) {
        return _c(_vm.field.detailItemComponent, {
          key: index,
          tag: "component",
          attrs: { item: item }
        })
...
Component.options.__file = "resources/js/components/DetailFieldItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1f0a1441", Component.options)
  } else {
    hotAPI.reload("data-v-1f0a1441", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("p", { staticClass: "pb-4" }, [_vm._v(_vm._s(_vm.item))])
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1f0a1441", module.exports)
  }
}
...
var update = __webpack_require__(16)("61ca5373", content, false, {});
    ...
    methods: {
        setInitialValue: function setInitialValue() {
            ...
            this.$nextTick(function () {
                _this.items = _this.value ? JSON.parse(_this.value) : [];
            });
        },
...
(function () {
  ...
  if (true) {
    var Sortable = __webpack_require__(20);
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("template", { staticClass: "nova-items-field", slot: "field" }, [
        _vm.field.listFirst == false
          ? _c(
              "div",
              {
                staticClass:
                  "nova-items-field-input-wrapper flex border border-40 p-4"
              },
              [
                _vm.field.inputType === "checkbox"
                  ? _c("input", {
                      directives: [
                        {
                          name: "model",
                      ...
                      domProps: {
                        checked: Array.isArray(_vm.newItem)
                          ? _vm._i(_vm.newItem, null) > -1
                          : _vm.newItem
                      },
                      on: {
                  ...
                  ? _c("input", {
                      ...
                      domProps: { checked: _vm._q(_vm.newItem, null) },
                      on: {
                        change: function($event) {
                          _vm.newItem = null
                        }
                ...
                _c("a", {
                  staticClass:
                    "btn btn-default btn-primary ml-3 cursor-pointer",
                  domProps: { innerHTML: _vm._s(_vm.field.createButtonValue) },
        ...
        _vm.items.length
          ? _c(
              ...
              {
                staticClass:
                  "nova-items-field-input-items list-reset border border-40",
              ...
              [
                _c(
                  "draggable",
                  {
                    attrs: {
                      options: {
                        disabled: _vm.field.draggable == false,
                    ...
                    return _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "nova-items-field-input-wrapper-item flex py-1 pb-4"
                          },
                          [
                            _vm.field.draggable
                              ? _c(
                                  ...
                                  {
                                    staticClass:
                                      "sortable-handle py-2 pl-0 pr-4 text-80 cursor-move"
                                  },
                                  [
                                    _vm._v(
                                      "\n                        |||\n                    "
                            ...
                            _c("input", {
                              ...
                              class: {
                                "border-danger": _vm.hasErrors(
                                  _vm.field.attribute + "." + index
                                )
                              },
                              attrs: {
                                type: _vm.field.inputType,
                                name: _vm.field.name + "[" + index + "]"
                              },
                              domProps: { value: item },
                              on: {
                                keyup: function($event) {
                                  _vm.updateItem(index, $event)
                                }
                              }
                            }),
                            _vm._v(" "),
                            _c("span", {
                              staticClass:
                                "ml-4 mr-2 font-thin text-2xl cursor-pointer hover:font-normal",
                              domProps: {
                                innerHTML: _vm._s(_vm.field.deleteButtonValue)
                              },
                              on: {
                        ...
                        _vm._v(" "),
                        _vm.hasErrors(_vm.field.attribute + "." + index)
                          ? _c(
                              "div",
                              {
                                staticClass:
                                  "help-text error-text -mt-2 text-danger pb-2"
                              },
                              [
                                _c("p", {
                                  domProps: {
